...
namespace SnakeGame
{
    class Program
    {
        ...
        static List<int[]> snake = new List<int[]>();
        static List<int[]> mines = new List<int[]>();
        static int[] food = new int[2];
        ...
        {
            for (int i = 0; i < 5; i++) // Change 5 to the desired number of mines
            {
                int[] mine = new int[2];
                do
                {
                ...
                } while (IsPositionOccupied(mine[0], mine[1]));
